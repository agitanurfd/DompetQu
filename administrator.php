...
$jumlahTabel = 5; //jumlah maisng2 tabel ada 5, jika sudah 5 maka akan lanjut ke next tabel
$jumlahData = count(query("SELECT * FROM users WHERE username NOT LIKE 'admin'"));
//Count berfungsi untuk menghitung jumlah elemen dalam array.
$jumlahHalaman = ceil($jumlahData / $jumlahTabel);
//Ceil berfungsi untuk pembulatan angka ke atas, artinya bilangan desimal akan dibulatkan ke bilangan bulat terdekat di atasnya.
...
//LIMIT mempermudah dan mempercepat pengambilan data, bisa dibayangkan jika anda memiliki ribuan data dan langsung menampilkan semua data tersebut, tentu beban server anda semakin berat.Oleh sebab itu klausa limit digunakan untuk menangani jumlah data yang sangat besar untuk meringankan kinerja server yang anda gunakan.
...
<body>
                            ...
                            <div class="col-7 d-flex align-items-center tulisan">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title ket total"><?= mysqli_num_rows($jumlahUser) ?> User
                                        <!--mysqli_num_rows digunakan untuk mengetahui beberapa jumlah baris di dalam tabel database.-->
                                    </h4>
                                </div>
                            </div>
                        </div>
    ...
    <!--FUNCTION UNTUK CARI NAMA USER-->
    <script src="js/bootstrap.js"></script>
    <!--FUNCTION UNTUK UPDATE USER DI BAGIAN EDIT DATA USER-->
    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    <!--UNTUK MEMBERI ALERT/PERINGATAN-->

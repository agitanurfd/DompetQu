...
$pengeluaran = query("SELECT * FROM pengeluaran WHERE tanggal = '$today' AND username = '$ambilNama'"); //query untuk mengakses dan menampilkan data pada sistem database.
?>
...
<body>
    ...
    <!--BAGIAN DATA PENGELUARAN DI DATA HARIAN-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="keteranganTambah" class="form-control">
                    ...
                    <!--MASUKKAN KEPERLUAN PENGGELUARAN-->
                    <div class="form-group">
                        <label>Masukkan Keperluan Pengeluaran</label>
                        <input type="text" id="keperluanTambah" class="form-control" required>
                    </div>

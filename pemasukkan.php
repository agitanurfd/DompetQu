...
if (isset($_COOKIE['login'])) { //isset untuk memeriksa apakah suatu variabel sudah diatur atau belum
	if ($_COOKIE['level'] == 'user') { //$_COOKIE untuk menyimpan data website pada browser, jd saat user kembali ke halaman yg pernah dibuka sebelumnya, informasi tsb dpt diambil kembali dari browser.
		$_SESSION['login'] = true; //jd klo user login trs hasilnya true akan di pindahkan ke halaman dashboard user
		$ambilNama = $_COOKIE['login'];
	} elseif ($_COOKIE['level'] == 'admin') {
		$_SESSION['login'] = true; //jika admin login dan hasilnya true maka akan dipindahkan ke halaman admin
...
if (empty($_SESSION['login'])) { //jika kosong akan dipindahkan ke halaman login
...
$pemasukkan = query("SELECT * FROM pemasukkan WHERE tanggal = '$today' AND username = '$ambilNama'"); //query untuk mengakses dan menampilkan data pada sistem database.
?>
...
<body>
		...
		<div class="konten khusus2">
			<div class="konten_dalem khusus3">
				...
				<div class="row cari-filter">
					...
					<!-- nama username yg disembunyikan di dekat bagian pilih tanggal-->
					<div class="col-lg-4">
						<input type="hidden" id="username" value="<?= $ambilNama ?>">
					</div>

					<!--bagian search atau pencarian-->
					<div class="col-lg-3">
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-sm table-hover table-striped table-bordered">
									...
									<?php $i = 1; // untuk no dalam tabel
									?>
									<?php foreach ($pemasukkan as $row) //query database pemauskkan ini masuk ke row atau tabel
										: ?>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<!--MASUKKAN KETERANGAN PEMASUKKAN-->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" id="jumlahTambah" name="jumlah" class="form-control" onkeydown="return (this, event);" onkeyup="javascript:tandaPemisahTitik(this);" required> <!-- ada di pisahTitik.js-->
					</div>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="jumlahMasuk" onkeydown="return (this, event);" onkeyup="javascript:tandaPemisahTitik(this);" required>
					</div>
				</div>
	...
	<!-- double modal, untuk memanggil misalnya ubah data ketika diklik muncul form ubah data -->
	<script>
